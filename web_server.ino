...
const char *ssid = "Andre23";
const char *password = "holaswert";
...
void loop() {
 ...
 // and a content-type so the client knows what's coming, then a blank line:
            ...
            client.println(".button { background-color: #62DF3D; border: none; color: white; padding: 16px 40px;");
            client.println("text-decoration: none; font-size: 30px; margin: 2px; cursor: pointer;}");
            client.println(".button2 {background-color:#A54F33 ;}</style></head>");

            client.println("<style>html { font-family: Helvetica; display: inline-block; margin: 0px auto; text-align: center;}");
            client.println(".button3 { background-color: #DFDF3D; border: none; color: white; padding: 16px 40px;");
            client.println("text-decoration: none; font-size: 30px; margin: 2px; cursor: pointer;}");
            client.println(".button4 {background-color: #3DC1DF;}</style></head>");
